      ...
      <div className="footer__main">
        <div className="container footer__grid">
          ...
          <div className="footer__brand">
            <button className="footer-logo" onClick={() => navigate('home')} aria-label="Go to homepage">
              <div className="footer-logo-mark"><span>A</span></div>
              <div>
            ...
            <p>
              A proud member of the Galileo Global Education group — one of Europe's leading
              higher education institutions, dedicated to shaping tomorrow's business leaders.
            </p>
          ...
          <div className="footer__col footer__contact">
            ...
            <button className="footer-apply-btn" onClick={() => navigate('contact')}>
